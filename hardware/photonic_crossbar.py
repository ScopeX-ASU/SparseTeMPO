...
class PhotonicCrossbar(PhotonicCore):
    ...
    def cal_architecture_power(self):
        ...
        self.architecture_photo_detector_power = (self.num_tiles * self.num_pe_per_tile) \
                                                 * self.core_photo_detector_power
        ...
        self.architecture_modulation_power = (self.sharing_r * self.num_pe_per_tile) \
                                             * self.input_power_modulation

        self.architecture_dac_power = (self.sharing_r * self.num_pe_per_tile) \
                                      * self.input_power_dac

        self.architecture_TIA_power = (self.num_tiles * self.sharing_c) * self.core_TIA_power

        self.architecture_adc_power = (self.num_tiles * self.sharing_c) * self.core_power_adc
    ...
    def cal_core_power(self):
        ...
        return core_power, core_power_common
