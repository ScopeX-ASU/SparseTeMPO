...
LastEditTime: 2024-04-27 15:22:23
FilePath: /SparseTeMPO/scripts/fmnist/cnn/train/pretrain.py
'''
"""
...
dataset = "fmnist"
model = "cnn"
root = f"log/{dataset}/{model}/pretrain"
...
if __name__ == "__main__":
    ...
    tasks = [
        # (1, 8, 8, "magnitude", "gradient", "uniform", [8, 8, 8, 8], 1, 1), # prodigy
        # (0.002, 8, 8, "magnitude", "gradient", "uniform", [8, 8, 8, 8], 2, 2), # adam
        (0.002, 8, 8, "magnitude", "gradient", "uniform", [8, 8, 8, 8], 3, 2), # adam
    ]
    with Pool(10) as p:
