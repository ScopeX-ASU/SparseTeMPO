'''
Date: 2024-03-26 14:06:24
LastEditors: Jiaqi Gu && jiaqigu@asu.edu
LastEditTime: 2024-03-26 14:06:24
FilePath: /SparseTeMPO/scripts/cifar10/resnet18/train.py
'''
"""
...
def task_launcher(args):
    ...
    with open(
        os.path.join(root, f"{model}_{dataset}_lr-{lr:.3f}_wb-{w_bit}_ib-{in_bit}_run-{id}.log"), "w"
    ) as wfid:
        exp = [
            f"--optimizer.lr={lr}",
